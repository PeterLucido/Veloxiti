      ...
      <div className="w-full mx-auto relative">
        <div className="relative flex h-screen">
          ...
          <div className="flex flex-col justify-center text-white px-16 translate-x-10">
            <section className="relative z-5 flex flex-col items-start justify-center h-full text-left">
              ...
              <ButtonComponent
                className="absolute left-0 z-50 bg-[#FF00FF] hover:bg-[#FF66FF] text-white text-2xl py-2 px-4 rounded-md transition-colors"
                buttonLink="/Contact"
                buttonText="Contact"
